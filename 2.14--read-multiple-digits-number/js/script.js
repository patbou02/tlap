...
function readMultipleDigitsNumber() {
  console.log("=== 2.14 - Read Multiple Digits Number ===");
  console.info("page 46-47 - Tracking State: Read multiple digits number. This is an expanded version of 1.13 so that it can accommodate larger numbers");
